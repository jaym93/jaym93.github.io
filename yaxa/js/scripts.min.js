    ...
    n.VERSION = "3.2.0", n.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (l) {
                ...
                s = "bottom" == s && c.top + c.height + p - h.scroll > h.height ? "top" : "top" == s && c.top - h.scroll - p < 0 ? "bottom" : "right" == s && c.right + u > h.width ? "left" : "left" == s && c.left - u < h.left ? "right" : s, o.removeClass(f).addClass(s)
            }
...
function(t) {
    ...
    "function" == typeof define && define.amd ? define(s) : t.classie = s
        ...
        function l(t, e, n) {
            ...
            return o(e, "string") || o(e, "undefined") ? s(r, e) : (r = (t + " " + C.join(i + " ") + i).split(" "), a(r, e, n))
        }
        var c, u, p, f = "2.8.3",
            d = {},
            h = !0,
            ...
            I = function(t, n, i, o) {
                ...
                return r = ["&#173;", '<style id="s', g, '">', t, "</style>"].join(""), c.id = g, (u ? c : p).innerHTML += r, p.appendChild(c), u || (p.style.background = "", p.style.overflow = "hidden", l = m.style.overflow, m.style.overflow = "hidden", m.appendChild(p)), s = n(c, t), u ? c.parentNode.removeChild(c) : (p.parentNode.removeChild(p), m.style.overflow = l), !!s
            },
            k = function() {
                function t(t, r) {
            ...
            _ = {}.hasOwnProperty;
        p = o(_, "undefined") || o(_.call, "undefined") ? function(t, e) {
            ...
            var n = S.call(arguments, 1),
                i = function() {
                    if (this instanceof i) {
                        ...
                        var r = new o,
                            s = e.apply(r, n.concat(S.call(arguments)));
            ...
            var n;
            return "ontouchstart" in t || t.DocumentTouch && e instanceof DocumentTouch ? n = !0 : I(["@media (", b.join("touch-enabled),("), g, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(t) {
                n = 9 === t.offsetTop
            }), n
        }, T.cssanimations = function() {
            return l("animationName")
        };
        for (var L in T) p(T, L) && (u = L.toLowerCase(), d[u] = T[L](), E.push((d[u] ? "" : "no-") + u));
        return d.addTest = function(t, e) {
                if ("object" == typeof t)
                    for (var i in t) p(t, i) && d.addTest(i, t[i]);
                else {
                    if (t = t.toLowerCase(), d[t] !== n) return d;
                    e = "function" == typeof e ? e() : e, "undefined" != typeof h && h && (m.className += " " + (e ? "" : "no-") + t), d[t] = e
                }
                return d
            }, i(""), v = c = null,
            function(t, e) {
                ...
                function r(t, n, i) {
                    ...
                    i || (i = o(n));
                    var r;
                    return r = i.cache[t] ? i.cache[t].cloneNode() : h.test(t) ? (i.cache[t] = i.createElem(t)).cloneNode() : i.createElem(t), !r.canHaveChildren || d.test(t) || r.tagUrn ? r : i.frag.appendChild(r)
                }
                ...
                t.html5 = y, l(e)
            }(this, e), d._version = f, d._prefixes = b, d._domPrefixes = C, d._cssomPrefixes = x, d.hasEvent = k, d.testProp = function(t) {
                return s([t])
            }, d.testAllProps = l, d.testStyles = I, d.prefixed = function(t, e, n) {
                return e ? l(t, e, n) : l(t, "pfx")
            }, m.className = m.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (h ? " js " + E.join(" ") : ""), d
    }(this, this.document),
    function(t, e, n) {
        function i(t) {
        ...
        function l(t, n, i, o, r, l, c) {
            ...
            1 === I[n] && (g = 1, I[n] = []), "object" == t ? p.data = n : (p.src = n, p.type = t), p.width = p.height = "0", p.onerror = p.onload = p.onreadystatechange = function() {
                u.call(this, g)
            }, v.splice(o, 0, b), "img" != t && (g || 2 === I[n] ? (x.insertBefore(p, w ? null : m), h(u, c)) : I[n].push(p))
        }

        function c(t, e, n, i, r) {
            return y = 0, e = e || "j", o(t) ? l("c" == e ? T : C, t, e, this.i++, n, i, r) : (v.splice(this.i++, 0, t), 1 == v.length && a()), this
        }
        ...
        f = function(t) {
            ...
            function s(t, o, r, s, a) {
                var l = e(t),
                    c = l.autoCallback;
                l.url.split(".").pop().split("?").shift(), l.bypass || (o && (o = i(o) ? o : o[t] || o[s] || o[t.split("/").pop().split("?")[0]]), l.instead ? l.instead(t, o, r, s, a) : (I[l.url] ? l.noexec = !0 : I[l.url] = 1, r.load(l.url, l.forceCSS || !l.forceJS && "css" == l.url.split(".").pop().split("?").shift() ? "c" : n, l.noexec, l.attrs, l.timeout), (i(o) || i(c)) && r.load(function() {
                    u(), o && o(l.origUrl, a, s), c && c(l.origUrl, a, s), I[l.url] = 2
                })))
            }
                    ...
                    if (t) {
                        if (o(t)) n || (p = function() {
                            ...
                            for (l in a = function() {
                                    ...
                                    return n
                                }(), t) t.hasOwnProperty(l) && (!n && !--a && (i(p) ? p = function() {
                                var t = [].slice.call(arguments);
                                f.apply(this, t), d()
                            } : p[l] = function(t) {
                                return function() {
            ...
            if (o(t)) s(t, 0, p, 0);
                ...
                for (l = 0; l < t.length; l++) c = t[l], o(c) ? s(c, 0, p, 0) : E(c) ? f(c) : Object(c) === c && a(c, p);
            ...
            var u, p, d = e.createElement("script"),
                o = o || f.errorTimeout;
            d.src = t;
            for (p in i) d.setAttribute(p, i[p]);
            n = c ? a : n || r, d.onreadystatechange = d.onload = function() {
                !u && s(d.readyState) && (u = 1, n(), d.onload = d.onreadystatechange = null)
            }, h(function() {
                u || (u = 1, n(1))
    ...
    function(t, e) {
        ...
        s.prototype = new e, s.prototype.options = {}, s.prototype.getImages = function() {
            ...
            function t(t, o) {
                return e.options.debug && p && u.log("confirm", t, o), e.progress(t), n++, n === i && e.complete(), !0
            }
            var e = this,
                n = 0,
    ...
    function(t, e, n) {
        ...
        "use strict";
        var e, n, i, o, r = {},
            s = !!t.document.querySelector && !!t.addEventListener,
            a = {
                speed: 500,
            ...
            l = function() {
                ...
                for (var o = function(n) {
                        for (var i in n) Object.prototype.hasOwnProperty.call(n, i) && (t[i] = e && "[object Object]" === Object.prototype.toString.call(n[i]) ? l(!0, t[i], n[i]) : n[i])
                    }; i > n; n++) {
                    var r = arguments[n];
                    o(r)
                }
            ...
            u = function(t, e) {
                var n, i, o = e.charAt(0),
                    r = "classList" in document.documentElement;
                for ("[" === o && (e = e.substr(1, e.length - 2), n = e.split("="), n.length > 1 && (i = !0, n[1] = n[1].replace(/"/g, "").replace(/'/g, ""))); t && t !== document; t = t.parentNode) {
                    if ("." === o)
                        if (r) {
            ...
            p = function(t) {
                for (var e, n = String(t), i = n.length, o = -1, r = "", s = n.charCodeAt(0); ++o < i;) {
                    ...
                    r += e >= 1 && 31 >= e || 127 == e || 0 === o && e >= 48 && 57 >= e || 1 === o && e >= 48 && 57 >= e && 45 === s ? "\\" + e.toString(16) + " " : e >= 128 || 45 === e || 95 === e || e >= 48 && 57 >= e || e >= 65 && 90 >= e || e >= 97 && 122 >= e ? n.charAt(o) : "\\" + n.charAt(o)
                }
                return r
            },
            f = function(t, e) {
        ...
        r.animateScroll = function(e, n, r) {
            var s = m(e ? e.getAttribute("data-options") : null),
                c = l(c || a, r || {}, s);
            n = "#" + p(n.substr(1));
            var u = "#" === n ? t.document.documentElement : t.document.querySelector(n),
                y = t.pageYOffset;
            i || (i = t.document.querySelector("[data-scroll-header]")), o || (o = v(i));
            var b, w, x, C = d(u, o, parseInt(c.offset, 10)),
                T = C - y,
                E = h(),
                S = 0;
            g(n, c.updateURL);
            var I = function(i, o, r) {
                    var s = t.pageYOffset;
                    (i == o || s == o || t.innerHeight + s >= E) && (clearInterval(r), u.focus(), c.callback(e, n))
                },
                k = function() {
                    S += 16, w = S / parseInt(c.speed, 10), w = w > 1 ? 1 : w, x = y + T * f(c.easing, w), t.scrollTo(0, Math.floor(x)), I(x, C, b)
                },
                _ = function() {
                    b = setInterval(k, 16)
                };
            0 === t.pageYOffset && t.scrollTo(0, 0), _()
        };
        var y = function(t) {
                var n = u(t.target, "[data-scroll]");
                n && "a" === n.tagName.toLowerCase() && (t.preventDefault(), r.animateScroll(n, n.hash, e))
            },
            b = function() {
        ...
        return r.destroy = function() {
            e && (t.document.removeEventListener("click", y, !1), t.removeEventListener("resize", b, !1), e = null, n = null, i = null, o = null)
        }, r.init = function(n) {
            s && (r.destroy(), e = l(a, n || {}), i = t.document.querySelector("[data-scroll-header]"), o = v(i), t.document.addEventListener("click", y, !1), i && t.addEventListener("resize", b, !1))
        }, r
    }),
    function(t) {
        function e() {}
        ...
        function i(t) {
            function i(t) {
                if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                    ...
                    for (var u = o.isBorderBox = !(!c || !i[c] || "border-box" !== i[c]), p = 0, f = s.length; f > p; p++) {
                        var d = s[p],
                            h = i[d];
                        h = a(t, h);
                        var m = parseFloat(h);
                    ...
                    var g = o.paddingLeft + o.paddingRight,
                        ...
                        C = u && l,
                        T = e(i.width);
                    T !== !1 && (o.width = T + (C ? 0 : g + w));
                    var E = e(i.height);
                    return E !== !1 && (o.height = E + (C ? 0 : v + x)), o.innerWidth = o.width - (g + w), o.innerHeight = o.height - (v + x), o.outerWidth = o.width + y, o.outerHeight = o.height + b, o
                }
            }
    ...
    function(t) {
        ...
        function r(t, n, r, l, u) {
            ...
            f.Item = l, f.LayoutMode = u, f.prototype._create = function() {
    ...
    function() {
        ...
        ! function(t, e) {
            ...
            var o, r, s, a, l, c, u, p, f, d, h, m, g, v, y, b;
            return o = n(i), p = t.call(i, "ontouchstart") >= 0, a = {
                horizontal: {},
                vertical: {}
            }, l = 1, u = {}, c = "waypoints-context-id", h = "resize.waypoints", m = "scroll.waypoints", g = 1, v = "waypoints-waypoint-ids", y = "waypoint", b = "waypoints", r = function() {
                function t(t) {
                    var e = this;
                ...
                init: function(t, e) {
                    ...
                    return e = n.extend({}, n.fn[y].defaults, e), null == (i = e.handler) && (e.handler = t), this.each(function() {
                        var t, i, o, a;
                        return t = n(this), o = null != (a = e.context) ? a : n.fn[y].defaults.context, n.isWindow(o) || (o = t.closest(o)), o = n(o), i = u[o[0][c]], i || (i = new r(o)), new s(t, i, e)
                    }), n[b]("refresh"), this
                },
                disable: function() {
                ...
                var t, i;
                return i = arguments[0], t = 2 <= arguments.length ? e.call(arguments, 1) : [], d[i] ? d[i].apply(this, t) : n.isFunction(i) ? d.init.apply(this, arguments) : n.isPlainObject(i) ? d.init.apply(this, [null, i]) : n.error(i ? "The " + i + " method does not exist in jQuery Waypoints." : "jQuery Waypoints needs a callback function or handler option.")
            }, n.fn[y].defaults = {
                context: i,
                continuous: !0,
                enabled: !0,
    ...
    function(t) {
        t.fn.countTo = function(e) {
            ...
            return t(this).each(function() {
                function o() {
                    a += i, s++, t(r).html(a.toFixed(e.decimals)), "function" == typeof e.onUpdate && e.onUpdate.call(r, a), s >= n && (clearInterval(l), a = e.to, "function" == typeof e.onComplete && e.onComplete.call(r, a))
                }
                var r = this,
                    s = 0,
                    a = e.from,
    ...
    function(t, e, n) {
        ...
        t.fn.backstretch = function(i, r) {
            return (i === n || 0 === i.length) && t.error("No images were supplied for Backstretch"), 0 === t(e).scrollTop() && e.scrollTo(0, 0), this.each(function() {
                ...
                n && (r = t.extend(n.options, r), n.destroy(!0)), n = new o(this, i, r), e.data("backstretch", n)
            })
        ...
        var i = {
            ...
            o = function(n, o, s) {
                if (this.options = t.extend({}, t.fn.backstretch.defaults, s || {}), this.images = t.isArray(o) ? o : [o], t.each(this.images, function() {
                        t("<img />")[0].src = this
                    }), this.isBody = n === document.body, this.$container = t(n), this.$wrap = t('<div class="backstretch"></div>').css(i.wrap).appendTo(this.$container), this.$root = this.isBody ? t(r ? e : document) : this.$container, !this.isBody) {
        ...
        var r = function() {
            var t = navigator.userAgent,
                ...
                s = !!r && r[1],
                a = t.match(/Opera Mobi\/([0-9]+)/),
                l = !!a && a[1],
                c = t.match(/MSIE ([0-9]+)/),
                u = !!c && c[1];
            return !((n.indexOf("iPhone") > -1 || n.indexOf("iPad") > -1 || n.indexOf("iPod") > -1) && o && 534 > o || e.operamini && "[object OperaMini]" === {}.toString.call(e.operamini) || a && 7458 > l || t.indexOf("Android") > -1 && o && 533 > o || s && 6 > s || "palmGetResource" in e && o && 534 > o || t.indexOf("MeeGo") > -1 && t.indexOf("NokiaBrowser/8.5.0") > -1 || u && 6 >= u)
        }()
    }(jQuery, window),
    function(t) {
        ...
        w.prototype = {
            ...
            open: function(n) {
                ...
                e.types = [], s = "", e.ev = n.mainEl && n.mainEl.length ? n.mainEl.eq(0) : o, n.key ? (e.popupsCache[n.key] || (e.popupsCache[n.key] = {}), e.currTemplate = e.popupsCache[n.key]) : e.currTemplate = {}, e.st = t.extend(!0, {}, t.magnificPopup.defaults, n), e.fixedContentPos = "auto" === e.st.fixedContentPos ? !e.probablyMobile : e.st.fixedContentPos, e.st.modal && (e.st.closeOnContentClick = !1, e.st.closeOnBgClick = !1, e.st.showCloseBtn = !1, e.st.enableEscapeKey = !1), e.bgOverlay || (e.bgOverlay = E("bg").on("click" + g, function() {
                    e.close()
                }), e.wrap = E("wrap").attr("tabindex", -1).on("click" + g, function(t) {
                ...
                S("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (T(f, function(t, e, n, i) {
                ...
                }, 16), e.isOpen = !0, e.updateSize(p), S(d), n
            },
            close: function() {
                e.isOpen && (S(c), e.isOpen = !1, e.st.removalDelay && !e.isLowIE && e.supportsTransition ? (e._addClassToMFP(y), setTimeout(function() {
                    e._close()
            ...
            appendContent: function(t, n) {
                e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && e.currTemplate[n] === !0 ? e.content.find(".mfp-close").length || e.content.append(I()) : e.content = t : e.content = "", S(p), e.container.addClass("mfp-" + n + "-holder"), e.contentContainer.append(e.content)
            },
            parseEl: function(n) {
                var i, o = e.items[n];
                if (o.tagName ? o = {
            ...
            _parseMarkup: function(e, n, i) {
                var o;
                i.data && (n = t.extend(i.data, n)), S(f, [e, n, i]), t.each(n, function(t, n) {
        ...
        var L, $, A, O = "inline",
            N = function() {
                A && ($.after(A.addClass(L)).detach(), A = null)
            };
                ...
                getInline: function(n, i) {
                    if (N(), n.src) {
                        ...
                        if (r.length) {
                            ...
                            s && s.tagName && ($ || (L = o.hiddenClass, $ = E(L), L = "mfp-" + L), A = r.after($).detach().removeClass(L)), e.updateStatus("ready")
        ...
        t.magnificPopup.registerModule(z, {
            ...
            proto: {
                initAjax: function() {
                    e.types.push(z), P = e.st.ajax.cursor, T(l + "." + z, D), T("BeforeChange." + z, D)
                },
                getAjax: function(n) {
                    ...
                    var o = t.extend({
                        ...
                        success: function(i, o, r) {
                            ...
                            S("ParseAjax", s), e.appendContent(t(s.data), z), n.finished = !0, j(), e._setFocus(), setTimeout(function() {
                                e.wrap.addClass(v)
        ...
        t.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                _onImageHasSize: function(t) {
                    t.img && (t.hasSize = !0, M && clearInterval(M), t.isCheckingImgSize = !1, S("ImageHasSize", t), t.imgHidden && (e.content && e.content.removeClass("mfp-loading"), t.imgHidden = !1))
                },
        ...
        t.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    ...
                    return e.direction = !0, n && n.enabled ? (s += " mfp-gallery", T(d + i, function() {
                    ...
                    }), T(f + i, function(t, i, o, r) {
                        var s = e.items.length;
                        o.counter = s > 1 ? U(n.tCounter, r.index, s) : ""
                    }), T("BuildControls" + i, function() {
                        if (e.items.length > 1 && n.arrows && !e.arrowLeft) {
                            var i = n.arrowMarkup,
                                o = e.arrowLeft = t(i.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(b),
                                s = e.arrowRight = t(i.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(b),
                                a = r ? "mfpFastClick" : "click";
                            o[a](function() {
                                e.prev()
                            }), s[a](function() {
                                e.next()
                            }), e.isIE7 && (E("b", o[0], !1, !0), E("a", o[0], !1, !0), E("b", s[0], !1, !0), E("a", s[0], !1, !0)), e.container.append(o.add(s))
                        }
                    }), T(h + i, function() {
                ...
                proto: {
                    iitRetina: function() {
                        if (window.devicePixelRatio > 1) {
                            var t = e.st.retina,
                                n = t.ratio;
                            n = isNaN(n) ? n() : n, n > 1 && (T("ImageHasSize." + X, function(t, e) {
                                e.img.css({
                                    "max-width": e.img[0].naturalWidth / n,
                                    width: "100%"
                                })
                            }), T("ElementParse." + X, function(e, i) {
                    ...
                    return t(this).each(function() {
                        ...
                        if (n) {
                            ...
                            a.on("touchstart" + r, function(t) {
                                p = !1, d = 1, f = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0], c = f.clientX, u = f.clientY, C.on("touchmove" + r, function(t) {
                                    f = t.originalEvent ? t.originalEvent.touches : t.touches, d = f.length, f = f[0], (Math.abs(f.clientX - c) > 10 || Math.abs(f.clientY - u) > 10) && (p = !0, i())
                                }).on("touchend" + r, function(t) {
                                    i(), p || d > 1 || (s = !0, t.preventDefault(), clearTimeout(l), l = setTimeout(function() {
                                        s = !1
                                    }, e), o())
                                })
                            })
        ...
        o.prototype = {
            ...
            _findParticles: function() {
                ...
                this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function() {
                    ...
                    e.options.showElement(f), f.data("stellar-startingLeft") ? (f.css("left", f.data("stellar-startingLeft")), f.css("top", f.data("stellar-startingTop"))) : (f.data("stellar-startingLeft", f.css("left")), f.data("stellar-startingTop", f.css("top"))), r = f.position().left, s = f.position().top, a = "auto" === f.css("margin-left") ? 0 : parseInt(f.css("margin-left"), 10), l = "auto" === f.css("margin-top") ? 0 : parseInt(f.css("margin-top"), 10), u = f.offset().left - a, p = f.offset().top - l, f.parents().each(function() {
                        var e = t(this);
                        return e.data("stellar-offset-parent") === !0 ? (d = m, h = g, c = e, !1) : (m += e.position().left, void(g += e.position().top))
            ...
            _findBackgrounds: function() {
                ...
                this.backgrounds = [], this.options.parallaxBackgrounds && (e = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (e = e.add(this.$element)), e.each(function() {
                    ...
                    h.data("stellar-backgroundStartingLeft") ? f(h, h.data("stellar-backgroundStartingLeft"), h.data("stellar-backgroundStartingTop")) : (h.data("stellar-backgroundStartingLeft", m[0]), h.data("stellar-backgroundStartingTop", m[1])), a = "auto" === h.css("margin-left") ? 0 : parseInt(h.css("margin-left"), 10), l = "auto" === h.css("margin-top") ? 0 : parseInt(h.css("margin-top"), 10), c = h.offset().left - a - o, u = h.offset().top - l - r, h.parents().each(function() {
                        var e = t(this);
                        return e.data("stellar-offset-parent") === !0 ? (g = y, v = b, p = e, !1) : (y += e.position().left, void(b += e.position().top))
            ...
            return e.prototype = {
                ...
                init: function() {
                    ...
                    this.elems = Array.prototype.slice.call(this.docElem.querySelectorAll("[data-scroll-reveal]")), this.elems.forEach(function(t) {
                        var i = t.getAttribute("data-scroll-reveal-id");
                        i || (i = n++, t.setAttribute("data-scroll-reveal-id", i)), e.styleBank[i] || (e.styleBank[i] = t.getAttribute("style")), e.update(t)
                    });
                    var o = function() {
                    ...
                    t.addEventListener("scroll", o, !1), t.addEventListener("resize", r, !1)
                },
                ...
                parseLanguage: function(t) {
                    ...
                    return n = e(n), n.forEach(function(t, e) {
                        switch (t) {
                            case "enter":
                                return void(i.enter = n[e + 1]);
                            case "after":
                                return void(i.after = n[e + 1]);
                            case "wait":
                                return void(i.after = n[e + 1]);
                            case "move":
                                return void(i.move = n[e + 1]);
                            case "ease":
                                return i.move = n[e + 1], void(i.ease = "ease");
                            case "ease-in":
                                return i.move = n[e + 1], void(i.easing = "ease-in");
                            case "ease-in-out":
                                return i.move = n[e + 1], void(i.easing = "ease-in-out");
                            case "ease-out":
                                return i.move = n[e + 1], void(i.easing = "ease-out");
                            case "over":
                                return void(i.over = n[e + 1]);
                            default:
                                return
                        }
                    }), i
                ...
                update: function(t) {
                    var e = this.genCSS(t),
                        n = this.styleBank[t.getAttribute("data-scroll-reveal-id")];
                    return null != n ? n += ";" : n = "", t.getAttribute("data-scroll-reveal-initialized") || (t.setAttribute("style", n + e.initial), t.setAttribute("data-scroll-reveal-initialized", !0)), this.isElementInViewport(t, this.options.viewportFactor) ? t.getAttribute("data-scroll-reveal-complete") ? void 0 : this.isElementInViewport(t, this.options.viewportFactor) ? (t.setAttribute("style", n + e.target + e.transition), void(this.options.reset || setTimeout(function() {
                        "" != n ? t.setAttribute("style", n) : t.removeAttribute("style"), t.setAttribute("data-scroll-reveal-complete", !0)
                    }, e.totalDuration))) : void 0 : void(this.options.reset && t.setAttribute("style", n + e.initial + e.reset))
                },
                genCSS: function(t) {
                    var e, n, i = this.parseLanguage(t);
                    i.enter ? (("top" == i.enter || "bottom" == i.enter) && (e = i.enter, n = "y"), ("left" == i.enter || "right" == i.enter) && (e = i.enter, n = "x")) : (("top" == this.options.enter || "bottom" == this.options.enter) && (e = this.options.enter, n = "y"), ("left" == this.options.enter || "right" == this.options.enter) && (e = this.options.enter, n = "x")), ("top" == e || "left" == e) && (i.move = i.move ? "-" + i.move : "-" + this.options.move);
                    var o = i.move || this.options.move,
                        r = i.over || this.options.over,
                        s = i.after || this.options.after,
                        a = i.easing || this.options.easing,
                        l = i.opacity || this.options.opacity,
                        c = "-webkit-transition: -webkit-transform " + r + " " + a + " " + s + ",  opacity " + r + " " + a + " " + s + ";transition: transform " + r + " " + a + " " + s + ", opacity " + r + " " + a + " " + s + ";-webkit-perspective: 1000;-webkit-backface-visibility: hidden;",
                        u = "-webkit-transition: -webkit-transform " + r + " " + a + " 0s,  opacity " + r + " " + a + " " + s + ";transition: transform " + r + " " + a + " 0s,  opacity " + r + " " + a + " " + s + ";-webkit-perspective: 1000;-webkit-backface-visibility: hidden;",
                        p = "-webkit-transform: translate" + n + "(" + o + ");transform: translate" + n + "(" + o + ");opacity: " + l + ";",
                        f = "-webkit-transform: translate" + n + "(0);transform: translate" + n + "(0);opacity: 1;";
                    return {
                        transition: c,
                        initial: p,
                        target: f,
                ...
                isElementInViewport: function(e, n) {
                    var i = t.pageYOffset,
                        ...
                        a = s + r,
                        n = n || 0;
                    return o >= s + r * n && a >= i || "fixed" == (e.currentStyle ? e.currentStyle : t.getComputedStyle(e, null)).position
                },
                extend: function(t, e) {
    ...
    function(t) {
        t.fn.showUp = function(e, n) {
            n = n || {};
            var i = t(e),
                o = n.down || "navbar-hide",
                r = n.up || "navbar-show",
                s = n.btnHideShow || ".btn-hide-show",
                a = n.offset || 110,
                l = 0;
            t(window).scroll(function() {
                t(this).scrollTop() > a && (t(this).scrollTop() > l ? i.removeClass(r).addClass(o) : i.removeClass(o).addClass(r)), l = t(this).scrollTop()
            }), t(s).click(function() {
                i.hasClass(o) ? i.removeClass(o).addClass(r) : i.removeClass(r).addClass(o)
            })
        }
